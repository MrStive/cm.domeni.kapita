...
class DemoServiceTest {
  ...
  void createDemoShouldReturnCreatedDemoIdTest() {
    ...
    DemoData mappedData = DemoData.builder().name("demo").build();
    UUID expectedId = UUID.randomUUID();
    Demo createdDemo = new Demo();
    createdDemo.setId(new DemoId(expectedId));
  ...
  void createDemoWhenMapperReturnsBlankNameShouldThrowInvalidDemoPayloadExceptionTest() {
    ...
    given(demoMapper.map(input)).willReturn(DemoData.builder().name(" ").build());
  ...
  void fetchAllDemosShouldReturnMappedDemoDtosTest() {
    ...
    firstDemo.setId(new DemoId(UUID.randomUUID()));
    Demo secondDemo = new Demo();
    secondDemo.setId(new DemoId(UUID.randomUUID()));
  ...
  @Test
  void fetchAllDemosWhenNoDataShouldReturnEmptyListTest() {
    // Given
    given(demoFetcher.loadAllDemos()).willReturn(List.of());
